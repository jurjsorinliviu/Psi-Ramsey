...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/jurjsorinliviu/Psi-Ramsey)
...
That means a new Codespace should start with Python available and the Ψ-Ramsey dependencies installed automatically.
...
Ψ-Ramsey was methodologically inspired in part by **Ψ-NN**, especially its teacher-student distillation and explicit structure-discovery workflow:
...
- The root-level runtime dependencies for Ψ-Ramsey are listed in `requirements.txt`.
